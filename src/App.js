...
const App=()=>{
    ...
    <br/>
    <h4>Leetcode</h4> <img src='https://raw.githubusercontent.com/PriyanshuSharma23/starter-code-recruitment-2023/4b7e0af6e80a389b2a01b4daae1f04d443576373/assets/unlink.svg' height="15px"/>
    <br/><br/><br/>
    <form id="registrationform" onSubmit={handleSubmit}>
      ...
      <div id="imgbox">
        <img id="preview-selected-image" src={imgUrl}/>
      </div><br/>
    ...
    {/* {
      ...
      <img src='https://raw.githubusercontent.com/PriyanshuSharma23/starter-code-recruitment-2023/4b7e0af6e80a389b2a01b4daae1f04d443576373/assets/algo-logo.svg' id='logo'/>
    </div>
  )
}
